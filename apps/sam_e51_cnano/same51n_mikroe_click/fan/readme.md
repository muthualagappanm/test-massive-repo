...
<h2 align="center"> <a href="https://github.com/MicrochipTech/MPLAB-Harmony-Reference-Apps/releases/latest/download/fan.zip" > Download </a> </h2>
...
1. If you haven't downloaded the Fan example demo yet [Click Here](https://github.com/MicrochipTech/MPLAB-Harmony-Reference-Apps/releases/latest/download/fan.zip) to download, otherwise go to next step  
...
- The Fan click example header files gets added to your project  
...
9. The **click_routines** folder contain an example C source file **fan_example.c**. You could use **fan_example.c** as a reference to add fan functionality to your application.
