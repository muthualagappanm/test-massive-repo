...
<h2 align="center"> <a href="https://github.com/MicrochipTech/MPLAB-Harmony-Reference-Apps/releases/latest/download/saml10_getting_started.zip" > Download </a> </h2>
...
> The application reads the current room temperature from the temperature sensor on the I/O1 Xplained Pro Extension.
  ...
  time you press the switch SW0 on the SAM L10 Xplained Pro Evaluation Kit. Also, an LED0 is toggled every time the temperature
...
- Open the project (getting_started\firmware\sam_l10_xpro.X) in MPLAB X IDE
...
<img src = "images/temp_sensor_placement.png" width="500" height="470" align="middle">  
- Press the switch SW0 on SAM L10 Xplained Pro Evaluation Kit to change the default sampling rate to one second  
<img src = "images/user_button_placement.png" width="500" height="470" align="middle">  
<img src = "images/result2.png" width="345" height="165" align="middle">  
- Every subsequent pressing of switch SW0 on SAM L10 Xplained Pro Evaluation Kit changes the default sampling rate to two seconds,
...
## Comments:
- Reference Training Module: [Getting Started with Harmony v3 Peripheral Libraries on SAM L10 MCUs](https://microchipdeveloper.com/harmony3:saml10-getting-started-training-module)
